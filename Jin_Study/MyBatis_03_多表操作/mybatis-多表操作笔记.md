...
<mapper namespace="com.jin.mapper.OrderMapper">
    <resultMap id="orderMap" type="com.jin.domain.Order">
...
<resultMap id="orderMap" type="com.jin.domain.Order">
    ...
    <association property="user" javaType="com.jin.domain.User">
...
<mapper namespace="com.jin.mapper.UserMapper">
    <resultMap id="userMap" type="com.jin.domain.User">
        <result column="id" property="id"></result>
        <result column="username" property="username"></result>
        <result column="password" property="password"></result>
        <result column="birthday" property="birthday"></result>
        <collection property="orderList" ofType="com.jin.domain.Order">
...
<resultMap id="userRoleMap" type="com.jin.domain.User">
    <result column="id" property="id"></result>
    <result column="username" property="username"></result>
    <result column="password" property="password"></result>
    <result column="birthday" property="birthday"></result>
    <collection property="roleList" ofType="com.jin.domain.Role">
...
<mappers>
    <!--扫描使用注解的类-->
    <mapper class="com.jin.mapper.UserMapper"></mapper>
</mappers>
```
...
<mappers>
    <!--扫描使用注解的类所在的包-->
    <package name="com.jin.mapper"></package>
</mappers>
```
...
public interface UserMapper {
    ...
    @Results({
            ...
            @Result(property = "orderList",column = "id",
                    javaType = List.class,
                    many = @Many(select = "com.jin.mapper.OrderMapper.findByUid"))
    })
    List<User> findAllUserAndOrder();
}
...
public interface UserMapper {
    ...
    @Results({
        ...
        @Result(property = "roleList",column = "id",
                javaType = List.class,
                many = @Many(select = "com.jin.mapper.RoleMapper.findByUid"))
})
List<User> findAllUserAndRole();}
...
<bean class="org.mybatis.spring.mapper.MapperScannerConfigurer">
    <property name="basePackage" value="com.jin.mapper"/>
</bean>
```
...
<aop:config>
<aop:pointcut id="txPointcut" expression="execution(* com.jin.service.impl.*.*(..))"/>
